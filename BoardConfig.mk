...
# Bootloader
TARGET_BOOTLOADER_BOARD_NAME := SRPTE18A003
TARGET_NO_BOOTLOADER := true
TARGET_NO_RADIOIMAGE := true

# File systems
BOARD_HAS_LARGE_FILESYSTEM := true
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 130400 # This is the maximum known partition size, but it can be higher, so we just omit it
